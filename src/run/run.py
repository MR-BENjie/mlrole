...
def run_sequential(args, logger):
    ...
    if args.judge_model_used:
        if args.runner == "parallel":
            for idx, parent_conn in enumerate(runner.parent_conns):
                data_input = {'Encode': learner.judge_model_encode, 'MlroleNode': learner.judge_model_node}
                parent_conn.send(("update_judge_model", data_input))
        else:
            data_input = {'Encode': learner.judge_model_encode, 'MlroleNode': learner.judge_model_node}
