...
class EpisodeRunner:
    ...
    def run(self, test_mode=False):
        ...
        while not terminated:
            ...
            if self.store_info:
                self.store_data['pre_state'].append(pre_transition_data)
            ...
            actions = self.mac.select_actions(self.batch, t_ep=self.t, t_env=self.t_env, test_mode=test_mode, store=self.store_data)

            if self.store_info:
                self.store_data['store_action'].append(actions[0])
